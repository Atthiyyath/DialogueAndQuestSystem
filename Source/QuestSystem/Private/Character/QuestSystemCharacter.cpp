...
AQuestSystemCharacter::AQuestSystemCharacter()
{
	...
	PlayerQuestComponent = CreateDefaultSubobject<class UPlayerQuestComponent>(TEXT("PlayerQuestComponent"));
}
...
void AQuestSystemCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
